...
interface PhotosResponse {
  photos: Array<{
    ...
    // Present on the wire (the route spreads the whole images row); the grid needs
    // it to tell "preview still generating" apart from "preview failed" instead of
    // rendering a silent blank tile.
