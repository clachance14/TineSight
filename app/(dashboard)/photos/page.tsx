...
// TEMPORARILY DISABLED - investigating iOS Safari crash
...
function PhotosContent(): React.JSX.Element {
  ...
  // Realtime subscription TEMPORARILY DISABLED - investigating iOS Safari crash
  ...
  const serviceFilters: ServicePhotoFilters = {
    ...
    // REDUCED from 50 - testing iOS Safari memory crash
    limit: 15,
  }
