  ...
  return (
    <main className="grid min-h-svh bg-deep-forest text-parchment lg:grid-cols-[1.05fr_1fr]">
      <aside className="relative m-4 hidden overflow-hidden rounded-xl border border-brass/20 bg-forest lg:block">
        <Image src="/landing/whitetail-dusk.webp" alt="A whitetail buck standing at the edge of the woods at dusk" fill sizes="50vw" className="object-cover object-[50%_40%]" />
      ...
      <div className="flex min-h-svh flex-col px-6 sm:px-12 lg:px-14">
        ...
        <div className="mx-auto flex w-full max-w-[384px] flex-1 flex-col justify-center py-10 sm:py-14">
          <p className="mb-5 text-[10px] uppercase tracking-[0.25em] text-brass-light">Back to your collection</p>
          <h1 className="font-display text-5xl font-medium leading-tight tracking-tight">Welcome back.</h1>
          <p className="mb-9 mt-4 text-sm leading-7 text-weathered">Your next sighting is part of a bigger story.<br />Sign in to pick up where you left off.</p>
