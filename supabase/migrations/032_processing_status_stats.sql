-- ============================================================================
-- Extend Photo Stats RPC with Processing Status Counts
-- ============================================================================
-- Adds pending_photos and processing_photos counts to support real-time
-- batch processing status display on the photos page.
-- ============================================================================

-- Replace the existing function with extended version
...
RETURNS TABLE(
  ...
  pending_photos bigint,      -- NEW: detection_status = 'pending'
  processing_photos bigint,   -- NEW: detection_status = 'processing'
  buck_count bigint,
  doe_count bigint,
